        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input class="form-control" type="file" name="ds_img"><br>
                    <input class="form-control" type="file" name="ds_img_2"><br>
                    <input class="form-control" style="display: none;" type="text" name="id" placeholder="id" value="<?php echo $noticia['id']; ?>"><br>
                   <input class="form-control" type="text" name="nm_noticia" placeholder="Titulo" value="<?php echo $noticia['nm_noticia']; ?>"><br>
                   <textarea class="form-control" name="ds_noticia" placeholder="Descrição">
